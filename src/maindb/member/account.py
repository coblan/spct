...
def account_tab(self):
    ...
    ls = [
        ...
        {'name': 'MatchesStatistics',
         ...
         'com': 'com-tab-table',
         'par_field': 'accountid',
         'lazy_init':'cfg.show_load();ex.director_call("d.get_head_context",{director_name:"account.matches_statistics"}).then(resp=>{cfg.hide_load();scope.head.table_ctx=resp})',
